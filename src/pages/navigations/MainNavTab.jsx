...
import Activitiy from '../common/Activity/main/Activity';
...
import WebViewComponent from '../common/Profile/main/WebView';
  ...
  return (
    <NewThreadStack.Navigator>
      <NewThreadStack.Screen
        options={{header: () => <NewthreadHeader />}}
        name="NewThreadPage"
        component={NewThread}
      />
    </NewThreadStack.Navigator>
...
const MyProfileStack = () => {
  return (
    <ProfileStack.Navigator>
      ...
      />
      <ProfileStack.Screen
        options={{header: () => <ProfileCustomHeader mytext="Settings" />}}
        name="Settings"
        ...
        {({isTabBarVisible}) => (
          <NavigationContainer>
            <Tabs.Navigator
              ...
              tabBar={props =>
                isTabBarVisible ? <NavTab {...props} /> : null
              }>
